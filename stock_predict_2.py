...
def train_lstm(batch_size=80, time_step=20, train_begin=2000, train_end=5800):
    ...
    with tf.Session() as sess:
        ...
        for i in range(11):
            ...
            print(i, loss_)
            if i % 10 == 0:
                print("----", saver.save(sess, './model2/graph.ckpt', global_step=i))


# train_lstm(train_begin=0)
