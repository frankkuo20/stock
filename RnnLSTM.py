...
class RnnLSTM:
    ...
    def _setModelPath(self):
        modelPath = 'model/{}/'.format(self.stockNo)
    ...
    def get_train_data(self, batch_size=60, time_step=20, train_begin=0, train_end=3400):
    ...
    def get_test_data(self, time_step=20, test_begin=3401):
        input_size = self.input_size
        data = self.data
    ...
    def train_lstm(self, batch_size=80, time_step=20, train_begin=0, train_end=3400):
        input_size = self.input_size
